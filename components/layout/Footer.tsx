    ...
    <footer className="bg-gray-900 py-12 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-3">
          {/* About */}
          <div>
            <h3 className="mb-4 text-lg font-bold">关于我</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tools" className="text-gray-400 transition-colors hover:text-white">
                  工具
                </Link>
              </li>
              <li>
                <Link href="/games" className="text-gray-400 transition-colors hover:text-white">
                  游戏
                </Link>
              </li>
            </ul>
          ...
          {/* Social Links */}
          <div>
            <h3 className="mb-4 text-lg font-bold">社交媒体</h3>
